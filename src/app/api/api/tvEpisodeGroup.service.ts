...
// @ts-ignore
import { EpisodeGroupDetails } from '../model/episodeGroupDetails';
...
export class TvEpisodeGroupRestControllerService extends BaseService implements TvEpisodeGroupRestControllerServiceInterface {
    ...
    public tvEpisodeGroupDetails(tvEpisodeGroupId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/tv/episode_group/${this.configuration.encodeParam({name: "tvEpisodeGroupId", value: tvEpisodeGroupId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<EpisodeGroupDetails>('get', `${basePath}${localVarPath}`,
            {
