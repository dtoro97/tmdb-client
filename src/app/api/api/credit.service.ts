...
// @ts-ignore
import { CreditDetails } from '../model/creditDetails';
...
export class CreditRestControllerService extends BaseService implements CreditRestControllerServiceInterface {
    ...
    public creditDetails(creditId: string, language?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/credit/${this.configuration.encodeParam({name: "creditId", value: creditId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<CreditDetails>('get', `${basePath}${localVarPath}`,
            {
