...
// @ts-ignore
import { TmdbConfiguration } from '../model/tmdbConfiguration';
...
export class ConfigurationRestControllerService extends BaseService implements ConfigurationRestControllerServiceInterface {
     ...
     * @param options additional options
     */
    public configurationDetails(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<TmdbConfiguration>;
    public configurationDetails(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<TmdbConfiguration>>;
    public configurationDetails(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<TmdbConfiguration>>;
    public configurationDetails(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<TmdbConfiguration>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
