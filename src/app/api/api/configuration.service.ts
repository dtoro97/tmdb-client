...
export class ConfigurationRestControllerService extends BaseService {
  ...
  ): Observable<HttpResponse<Array<Country>>>;
  public configurationCountries(
    language?: string,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<Array<Country>>>;
  public configurationCountries(
    language?: string,
    observe: any = 'body',
    ...
    return this.httpClient.request<Array<Country>>(
      'get',
  ...
  ): Observable<HttpResponse<Configuration>>;
  public configurationDetails(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<Configuration>>;
  public configurationDetails(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Configuration>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  ): Observable<HttpResponse<Array<Job>>>;
  public configurationJobs(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<Array<Job>>>;
  public configurationJobs(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<Job>>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  public configurationLanguages(
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<Language>>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param options additional options
   */
  public configurationPrimaryTranslations(
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json';
  ...
  public configurationTimezones(
    ...
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<Timezone>>(
      'get',
      `${basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
