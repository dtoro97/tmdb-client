...
export class PhotoViewerComponent {
    ...
    openPhotosPage(): void {
        ...
        this.dialogRef.close();
        if (Array.isArray(this.data.photosLink)) {
            this.router.navigate(this.data.photosLink as any[]);
            return;
        }

        this.router.navigateByUrl(this.data.photosLink);
    }
